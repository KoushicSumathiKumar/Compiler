...
public interface SimpleLangVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code ReassignExpr}
	 * labeled alternative in {@link SimpleLangParser#exp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReassignExpr(SimpleLangParser.ReassignExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code IdfrExpr}
	 * labeled alternative in {@link SimpleLangParser#exp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIdfrExpr(SimpleLangParser.IdfrExprContext ctx);
	/**

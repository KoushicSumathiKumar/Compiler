...
public class SimpleLangCodeGenerator extends AbstractParseTreeVisitor<String> implements SimpleLangVisitor<String>
{
    ...
    @Override public String visitAssignExpr(SimpleLangParser.AssignExprContext ctx)
    {
        ...
        localVars.put(ctx.typed_idfr().Idfr().getText(), 4 + 8 + localVars.size() * 4);
    ...
    @Override
    public String visitReassignExpr(SimpleLangParser.ReassignExprContext ctx) {
        StringBuilder sb = new StringBuilder();
    ...
    @Override public String visitIdfrExpr(SimpleLangParser.IdfrExprContext ctx)
    {
        StringBuilder sb = new StringBuilder();
    ...
    public String visitBoolExpr(SimpleLangParser.BoolExprContext ctx) {
        ...
        sb.append(String.format("""
            PushRel     (%d)
        """, localVars.get(ctx.BoolLit().getText()))
        );
    ...
    @Override
    public String visitMoreBinop(SimpleLangParser.MoreBinopContext ctx) {
        return null;
    }

    @Override
    public String visitMoreEqBinop(SimpleLangParser.MoreEqBinopContext ctx) {
        return null;
    }
